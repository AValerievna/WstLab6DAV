...
public class MenagerieDAO {
    ...
    private final String POSITION = "breed";
    private final String PLANET = "health";
    private final String BIRTHDATE = "arrival";
    ...
    private Menagerie resultSetToEntity(ResultSet rs) throws SQLException {
        ...
        String breed = rs.getString(POSITION);
        String health = rs.getString(PLANET);
        Date arrival = rs.getDate(BIRTHDATE);
